...
/*func TestKeyRevocationPrimarySigns(t *testing.T) {
	bob_key_armor := `-----BEGIN PGP PUBLIC KEY BLOCK-----
...
-----END PGP SIGNATURE-----
	...
	res, err := verifier.VerifyDetached([]byte(message), []byte(sig1))
	if err != nil {
		t.Error("error: ", err)
	}
	if err = res.SignatureError(); err != nil {
