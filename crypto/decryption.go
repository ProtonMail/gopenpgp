...
type PGPDecryption interface {
	...
	DecryptingReader(encryptedMessage Reader) (*VerifyDataReader, error)
	...
	Decrypt(pgpMessage []byte) (*VerifiedDataResult, error)
	...
	// to Decrypt.
	DecryptDetached(pgpMessage []byte, encDetachedSignature []byte) (*VerifiedDataResult, error)
